    ...
    public class ResponseHandler
    {
        ...
        public Response<T> Success<T>(T entity, object Meta = null, string message = null)
        {
            return new Response<T>()
            {
                ...
                StatusCode = System.Net.HttpStatusCode.OK,
                Succeeded = true,
                Message = message == null ? _stringLocalizer[SharedResourcesKeys.Retrieved] : message,
                Meta = Meta
            };
        }
        public Response<T> Updated<T>(T entity, object Meta = null, string message = null)
        {
            return new Response<T>()
            {
                Data = entity,
        ...
        public Response<T> Updated<T>(object Meta = null, string message = null)
        {
            return new Response<T>()
            {
                StatusCode = System.Net.HttpStatusCode.OK,
